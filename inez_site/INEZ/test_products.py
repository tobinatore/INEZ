from ..views import get_alternatives, check_products, calc_full_price, capitaliziation
...
class ProductTest(TestCase):
    ...
    def setUpTestData(cls):
        cls.banana = Grocery_List.objects.create(title="﻿EDEKA Bananen".replace(codes.BOM_UTF8,""), quantity="2",\
    ...
    def test_capitalization(self):
        self.assertEqual(capitaliziation(banana.title.lower()), banana.title)
